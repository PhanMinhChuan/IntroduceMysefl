          ...
          <%
			...
			%>
					<div class="about-author d-flex p-4 bg-light">
						<div class="bio mr-5">
							<a href="<%=urlSlug%>" class="block-20" style="background-image: url('<%=request.getContextPath()%>/templates/public/images/Book<%=item.getId()%>.jpg'); width:200px; height: 206px;"></a>	
						</div>
						<div class="desc">
			...
			<%
		            ...
		            <p>
		              <img src="<%=request.getContextPath()%>/templates/public/images/Book<%=news.getId()%>.jpg" alt="" class="img-fluid">
		            </p>
		            ...
		            <div class="about-author d-flex p-4 bg-light">
		              <div class="bio mr-5">
		                <img src="<%=request.getContextPath() %>/templates/public/images/anhdaidien2.jpeg" style="width: 100px;" alt="Image placeholder" class="img-fluid mb-4">
		              </div>
		              <div class="desc">
...
<!-- 		              </form> -->
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a href="<%=urlSlug %>" class="blog-img mr-4 block-20" style="background-image: url('<%=request.getContextPath()%>/templates/public/images/Book<%=item.getId()%>.jpg');"></a>
                <div class="text">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <p>A good book gives us a good thing, a good friend gives us a good thing!</p>
            </div>
            <div class="sidebar-box ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <p>Good books are like good friends, few and choosen, the more you choose, the more you enjoy.</p>
            </div>
          </div>
