			...
			%>
			  <li class="nav-item"><a href="#blog-section" class="nav-link"><span>Books</span></a>
					<ul class="dropdown-menu" >
						...
						<li><a href="<%=request.getContextPath()%>/blog?msg=2" class="dropdown-item dropdown-toggle">Văn Học</a>
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="<%=request.getContextPath()%>/blog?msg=3">Trinh Thám</a></li>
								<li><div class="dropdown-divider"></div></li>
								<li><a class="dropdown-item" href="<%=request.getContextPath()%>/blog?msg=4">Tình Cảm</a></li>
							</ul>
						</li>	
					</ul>
			  </li>
...
<!-- 	          images/bg_1.jpg   <%=request.getContextPath()%>/slide.jpg-->
	          	<div class="one-third order-md-last img" style="background-image:url(<%=request.getContextPath() %>/templates/public/images/slide99.jpg);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<a href="https://www.youtube.com/watch?v=_zMRe8CIMPk" class="icon-video popup-vimeo d-flex justify-content-center align-items-center"
		          	...
		          	<div class="text">
			            ...
			            <p><a href="<%=request.getContextPath() %>/templates/public/cv/PhanMinhChuan.pdf" class="btn-custom" download>Download CV</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	...
		          	<div class="text">
		          		<span class="subheading">Welcome to project</span>
			            <h1 class="mb-4 mt-4">Hope You <span>Like!</span></h1>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(<%=request.getContextPath() %>/templates/public/images/avatar.jpeg); height: 540px;width: 375px;margin-right: 22px;">
	    				</div>
    				</div>
    			</div>
    			<%
    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            <h2 class="mb-4" style="font-size: 26px;margin-top: 30px;">Tóm tắt bản thân</h2>
		            <p>Mình là <strong>Phan Minh Chuẩn</strong>, đến từ trường đại học Bách Khoa Đà Nẵng. Mình đã có kinh nghiệm 1 năm làm về các dự án java như Servlet-JSP, Spring Boot, Spring Security,...</p>
		            <p>Hãy cùng tìm hiểu con đường sự nghiệp của mình nhé!</p>
		          </div>
		          <div class="col-md-12 heading-section ftco-animate">
		            <h2 class="mb-4" style="font-size: 26px;margin-top: 40px;">Mục tiêu nghề nghiệp</h2>
		            <p>Mong muốn trở thành một Web Developer, mục tiêu của mình trong 2 năm tới sẽ trở thành FullStack Developer!</p>
		          </div>
		        </div>
		        <!-- Button trigger modal -->
						    ...
						    <div style="padding-top : 50px;padding-bottom:60px; border: 2px dashed;">
						    		<div class="row">
							          <div class="col-8 col-sm-4">
							            <img alt="" src="<%=request.getContextPath() %>/templates/public/images/anhdaidien.jpeg" style="width: 178px;height: 240px;margin-left:45px"/>
							          </div>
							          <hr>
						...
						<div class="khoi1">
							<div class="row">
								<div class="col-sm-5 work1">
									<h4>Join Stdio.Hue</h4>
									<p>Intern/Fresher Java Web Developer</p>
								</div>
							...
							<div class="row2">
								<div class="col-sm-5 work1">
									<h4>Graduated The University of Science and Technology</h4>
									<p>GPA: 3.03</p>
								</div>
								<div class="col-sm-5-me work7">
										<h5 style="width: 115px; margin-left: 120px;">05-2022</h5>
								</div>
								<div class="col-sm-2-me">
						...
						<div class="khoi2">
							<div class="row">
								...
								<div class="col-sm-5 work5">
									<h4 style="margin-top: 10px;">Join FPT software</h4>
									<p>Fresher Java Web Developer</p>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-2-me work6">
								...
								<div class="col-sm-5 work55">
									<h4>Join Japanese Language Proficiency Test</h4>
									<p>JLPT N2</p>
								</div>
							</div>
						</div>
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
    		...
    		<div class="row">
    			<%
			  	...
			  	%>
    			<div class="col-md-8">
    				<div class="project img ftco-animate img-2 d-flex justify-content-center align-items-center" style="background-image: url(<%=request.getContextPath() %>/templates/public/images/book.jpg);">
    					<div class="overlay"></div>
	    				<div class="text text-center p-4">
	    					<h3><a href="https://github.com/PhanMinhChuan/Books-Review"><%=projectList.get(0).getName() %></a></h3>
    			...
    			<div class="col-md-4">
    				<div class="row">
    					<div class="col-md-12">
		    				<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<%=request.getContextPath() %>/templates/public/images/scheduling.jpg); ">
		    					<div class="overlay"></div>
			    				<div class="text text-center p-4">
			    					<h3><a href="https://github.com/PhanMinhChuan/Scheduling-For-Companies"><%=projectList.get(1).getName() %></a></h3>
...
<%-- 				 <a href="<%=request.getContextPath() %>/blog?id=<%=item.getId()%>&idCat=<%=item.getCat_id()%>" class="block-20" style="background-image: url('<%=request.getContextPath()%>/files/<%=item.getPicture()%>');"></a> --%>
				 	...
				 	<a href="<%=urlSlug%>" class="block-20" style="background-image: url('<%=request.getContextPath()%>/templates/public/images/Book<%=item.getId()%>.jpg');"></a>
      ...
      <div class="container">
        ...
        <div class="row no-gutters block-9">
          ...
          <div class="col-md-6 d-flex">
          	<div class="img" style="background-image: url(<%=request.getContextPath() %>/templates/public/images/project-4.jpg);width: 480px; margin-left: 60px;"></div>
          </div>
          <%
					}
		  %>
